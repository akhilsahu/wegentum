			...
			<ul id="menu" class="collapse">
                ...
                <li class="panel ">
                    ...
                    <ul class="collapse" id="form-nav">
                        <li class=""><a href="<?php echo site_url();?>/employee/addcli"><i class="icon-angle-right"></i> Add</a></li>
                        <li class=""><a href="<?php echo site_url();?>/employee/cli_list"><i class="icon-angle-right"></i> Manage </a></li>
				...
				<li class="panel">
                    ...
                    <ul class="collapse" id="pagesr-nav">
                        <li><a href="<?php echo site_url();?>/employee/add_doc"><i class="icon-angle-right"></i> Add </a></li>
                        <li><a href="<?php echo site_url();?>/employee/doc_list"><i class="icon-angle-right"></i> Manage </a></li>
                ...
                <li class="panel">
                    <a href="#" data-parent="#menu" data-toggle="collapse" class="accordion-toggle" data-target="#DDL-nav">
                        <i class=" icon-sitemap"></i> Employee`
