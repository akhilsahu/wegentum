...
function delete_record(id)
{
	...
	if (r==true)
	{
		var id=id;
		$.ajax({
			url:"<?php echo site_url().'/employee/delete_doc/';?>"+id,
		...
		<div id="four-columns" class="grid-container" style="display:block;">
			...
			?>
				...
				<li id="delrow<?php echo $user['int_user_id'];?>">
					...
					<a href="<?php echo site_url().'/employee/download/'.$user['int_user_id'] ?>" class="btn btn-primary">Download</a> <a href="javascript:void(0)" class="btn btn-primary" onclick="delete_record(<?php echo $user['int_user_id'] ;?>)">Delete</a>
