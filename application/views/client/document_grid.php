...
foreach($users as $user)
{
  ...
  $complete_structure.='<tr role="row" class="odd">
						...
						<td><a href="'.site_url().'/client/download?id='.$user['int_user_id'].'">Download</a>
                            ...
                            <a class="del_confirm" href="'.site_url().'/client/delete_doc?id='.$user['int_user_id'].'">Delete</a>
            ...
            <div class="inner">
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
						...
						<form action="<?php echo site_url();?>/client/search" method="post" enctype="multipart/form-data">	
